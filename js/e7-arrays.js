...
function posicionLista() {
    ...
    let alumnoSeleccionado = listaAlumnos1[posicion];
...
function agregarNombre() {
    let nuevoNombre = document.getElementById("ej4lista").value;
    listaAlumnos1.push(nuevoNombre);
    listaAlumnos();
}
...
function eliminarPosicion() {
    ...
    listaAlumnos1.splice(posicion - 1, 1);
    listaAlumnos();
...
function ej6buscarNombre() {
    let nombre1 = document.getElementById("ej6agregar").value;
    let posicion1 = listaAlumnos1.indexOf(nombre1.toLowerCase()); 
    let mensaje = "";
    ...
    if (posicion1 === -1){
        ...
        let alumnoSeleccionado = listaAlumnos1[posicion1];
        mensaje = "Alumno seleccionado " + alumnoSeleccionado + " esta en la posicion " + posicion1;
    }

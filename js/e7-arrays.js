...
let listaAlumnos1 = ["Pepe","Laura","Jorge", "Rosa", "Candela","Lucas","Adriana","Francisco","Lorena","Pilar"];
...
function imprimir(mensaje,id){
    ...
    function listaAlumnos() {
        mensaje = "La lista de alumnos es: " + listaAlumnos1;
        imprimir(mensaje,"e1listaAlumnos");
}

//Ejercicio 2: NO SALE EL NOMBRE DEL ULTIMO DE LA LISTA

let listaAlumnos2 = ["Pepe","Laura","Jorge", "Rosa", "Candela","Lucas","Adriana","Francisco","Lorena","Pilar"];
...
function mostrarNombre () {
    let primerlista = listaAlumnos2[0]; //MOSTRAR PRIMER ELMENTO DE LA LISTA
    let longitudLista = listaAlumnos2.length; //MOSTRAR SU LONGITUD
    let ultimoLista = listaAlumnos2[longitudLista - 11]; //MOSTRAR EL ULTIMO ELEMENTO
    let mensaje = " El primer nombre de la lista es " + primerlista + " el ultimo nombre de la lista es " + ultimoLista + " la longitud de la lista es " + longitudLista;
    imprimir(mensaje,"ej2listaNombre");
}

//Ejercicio 3:

let listaAlumnos3 = ["Pepe","Laura","Jorge", "Rosa", "Candela","Lucas","Adriana","Francisco","Lorena","Pilar"];
...
function alumnosOrdenados(){
    listaAlumnos3.sort()
    listaAlumnos3.reverse();
    document.getElementById("ej3ordenados");
}